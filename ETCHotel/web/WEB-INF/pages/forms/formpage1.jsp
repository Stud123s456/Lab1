  ...
  <div class="card">
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-md-8">
          <!-- header -->
          <h4><fmt:message bundle="${labels}" key="user.card.header2"/></h4><br>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-floating mb-3">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="insuranceOptionId" value="1" id="typeid1">
            ...
            <div class="col-md-3">
              ...
              <div class="form-floating mb-3">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="periodId" value="1" id="periodId1">
